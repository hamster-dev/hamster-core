...
#TODO: figure out how to import fixtures, they are duplicated for unit and int tests
...
# Removed - the form-urlencoded webhook option isnt working right now
# @pytest.fixture
...
def pullrequest_object():
    ...
    with open(pth, 'r') as fh:
        data = fh.read()
        return PullRequest.from_webhook(json.loads(data))
